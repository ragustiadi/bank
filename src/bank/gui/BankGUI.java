...
public class BankGUI extends JFrame {
	...
	public void closeAccount() {
		...
		if (number != null) {
			int res = JOptionPane.showConfirmDialog(this,
					"Really close account " + number + "?", "Confirm closing",
	...
	public void deposit() {
		...
		if (number != null) {
			String s = JOptionPane.showInputDialog(this,
					"Enter amount to deposit:", "Deposit Money",
	...
	public void withdraw() {
		...
		if (number != null) {
			String s = JOptionPane.showInputDialog(this,
					"Enter amount to draw:", "Draw Money",
					JOptionPane.QUESTION_MESSAGE);
			if (s != null) {
				try {
					double amount = Double.parseDouble(s);
	...
	public void transfer() {
		...
		if (number != null) {
			try {
				...
				TransferDialog trans = new TransferDialog(this,
						"Transfer Money", number, s);
				Point loc = getLocation();
				...
				if (!trans.canceled()) {
					if (number.equals(trans.getAccountNumber())) {
						...
						try {
							double amount = Double.parseDouble(trans
									.getBalance());
							...
							fld_balance.setText(currencyFormat(from
									.getBalance()));

							JOptionPane.showMessageDialog(this,
									"Transfer successfull", "Information",
									JOptionPane.INFORMATION_MESSAGE);
						} catch (NumberFormatException e) {
							JOptionPane.showMessageDialog(this,
									"Illegal Balance", "Error",
									JOptionPane.ERROR_MESSAGE);
						} catch (IllegalArgumentException e) {
							JOptionPane.showMessageDialog(this,
							...
							JOptionPane.showMessageDialog(this,
									"At least one account is inactive",
									"Error", JOptionPane.ERROR_MESSAGE);
						} catch (OverdrawException e) {
							JOptionPane.showMessageDialog(this,
									"Account must not be overdrawn", "Error",
	...
	static class AboutBox extends JDialog {
		...
		public AboutBox(Frame parent) {
			...
			p_text.add(new JLabel("(c) D. Gruntz, 2001-2014",
