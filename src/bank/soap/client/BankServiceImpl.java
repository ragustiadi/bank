...
public interface BankServiceImpl {
	...
	@Action(input = "http://soap.bank/BankServiceImpl/transferRequest", output = "http://soap.bank/BankServiceImpl/transferResponse", fault = {
			...
			@FaultAction(className = IllegalArgumentException_Exception.class, value = "http://soap.bank/BankServiceImpl/deposit/Fault/IllegalArgumentException") })
	public void transfer(@WebParam(name = "a", targetNamespace = "") String a,
			@WebParam(name = "b", targetNamespace = "") String b,
			@WebParam(name = "amount", targetNamespace = "") double amount)
			throws IOException_Exception, InactiveException_Exception,
			OverdrawException_Exception, IllegalArgumentException_Exception; // Edited: IllegalArgumentException_Exception added here and in the method description
	...
	@Action(input = "http://soap.bank/BankServiceImpl/getOwnerRequest", output = "http://soap.bank/BankServiceImpl/getOwnerResponse", fault = { @FaultAction(className = IOException_Exception.class, value = "http://soap.bank/BankServiceImpl/getOwner/Fault/IOException") })
	...
	@Action(input = "http://soap.bank/BankServiceImpl/createAccountRequest", output = "http://soap.bank/BankServiceImpl/createAccountResponse", fault = { @FaultAction(className = IOException_Exception.class, value = "http://soap.bank/BankServiceImpl/createAccount/Fault/IOException") })
	public String createAccount(
			@WebParam(name = "owner", targetNamespace = "") String owner)
			throws IOException_Exception;
	...
	@Action(input = "http://soap.bank/BankServiceImpl/closeAccountRequest", output = "http://soap.bank/BankServiceImpl/closeAccountResponse", fault = { @FaultAction(className = IOException_Exception.class, value = "http://soap.bank/BankServiceImpl/closeAccount/Fault/IOException") })
	...
	@Action(input = "http://soap.bank/BankServiceImpl/getAccountNumbersRequest", output = "http://soap.bank/BankServiceImpl/getAccountNumbersResponse", fault = { @FaultAction(className = IOException_Exception.class, value = "http://soap.bank/BankServiceImpl/getAccountNumbers/Fault/IOException") })
	public List<Object> getAccountNumbers() throws IOException_Exception;
	...
	@Action(input = "http://soap.bank/BankServiceImpl/getAccountRequest", output = "http://soap.bank/BankServiceImpl/getAccountResponse", fault = { @FaultAction(className = IOException_Exception.class, value = "http://soap.bank/BankServiceImpl/getAccount/Fault/IOException") })
	...
	@Action(input = "http://soap.bank/BankServiceImpl/isActiveRequest", output = "http://soap.bank/BankServiceImpl/isActiveResponse", fault = { @FaultAction(className = IOException_Exception.class, value = "http://soap.bank/BankServiceImpl/isActive/Fault/IOException") })
	...
	public void deposit(
			...
			@WebParam(name = "amount", targetNamespace = "") double amount)
			throws IOException_Exception, InactiveException_Exception,
			IllegalArgumentException_Exception; // Edited: IllegalArgumentException_Exception added here and in the method description
	...
	@Action(input = "http://soap.bank/BankServiceImpl/getBalanceRequest", output = "http://soap.bank/BankServiceImpl/getBalanceResponse", fault = { @FaultAction(className = IOException_Exception.class, value = "http://soap.bank/BankServiceImpl/getBalance/Fault/IOException") })
